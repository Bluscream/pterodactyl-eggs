...
| :--- | :--- | :--- |
| **DayZ Standalone (No-BE Patched)** | [`dayz-nobe/`](./dayz-nobe) | DayZ server egg with automatic zero-dependency binary memory patcher, VAC bypass, and dual Release (`223350`) & Experimental (`1042420`) support. |
